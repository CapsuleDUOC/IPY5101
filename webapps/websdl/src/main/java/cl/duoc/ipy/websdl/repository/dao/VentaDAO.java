...
public class VentaDAO  implements IVentaDAO{
	...
	@Override
	public List<Venta> search(List<SearchCriteria> params) {
		final CriteriaBuilder builder = entityManager.getCriteriaBuilder();
		final CriteriaQuery<Venta> query = builder.createQuery(Venta.class);
		final Root<Venta> root = query.from(Venta.class);
