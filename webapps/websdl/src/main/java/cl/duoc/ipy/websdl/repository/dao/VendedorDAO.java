...
public class VendedorDAO implements IVendedorDAO{
	...
	@Override
	public List<Vendedor> search(List<SearchCriteria> params) {
		
		final CriteriaBuilder builder = entityManager.getCriteriaBuilder();
		final CriteriaQuery<Vendedor> query = builder.createQuery(Vendedor.class);
		final Root<Vendedor> root = query.from(Vendedor.class);
