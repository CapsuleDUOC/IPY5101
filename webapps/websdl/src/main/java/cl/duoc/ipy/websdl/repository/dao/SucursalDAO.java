...
public class SucursalDAO implements ISucursalDAO {
	...
	@Override
	public List<Sucursal> search(List<SearchCriteria> params) {
		final CriteriaBuilder builder = entityManager.getCriteriaBuilder();
		final CriteriaQuery<Sucursal> query = builder.createQuery(Sucursal.class);
		final Root<Sucursal> root = query.from(Sucursal.class);
